...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local --enable-libx265 --disable-shared --enable-static --enable-pthreads --enable-gpl --disable-x86asm --extra-ldflags=-L/usr/local/lib/ --extra-libs=-lstdc++ --enable-ffplay --enable-libmp3lame --enable-libx264 --enable-debug=3"
