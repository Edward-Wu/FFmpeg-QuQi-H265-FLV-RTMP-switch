...
extern int        g_overlay_switch;

static void sig_usr(int signo)
{
        if(signo == SIGUSR1) {
            printf("received signal ,switch overlay from %d to %d.\n", g_overlay_switch, !g_overlay_switch );
            g_overlay_switch = !g_overlay_switch;
...
int main(int argc, char **argv)
{
    ...
    av_log(NULL, AV_LOG_ERROR, ("signal SIGUSR1, ok.\n"));
    if(signal(SIGUSR1, sig_usr) == SIG_ERR)
        printf("can't catch SIGUSR1\n");
